...
pub static LUA_LIB: OnceLock<Library> = OnceLock::new();
...
generate! (LuaLib {
    ...
    pub unsafe extern "C" fn lua_l_loadbufferx(state: *mut LuaState, buff: *const u8, sz: usize, name: *const u8, mode: *const u8) -> u32;
    pub unsafe extern "C" fn lua_l_loadbuffer(state: *mut LuaState, buff: *const u8, sz: usize, name: *const u8) -> u32;
});
...
impl LuaLib {
    ...
    pub unsafe fn from_library(library: &Library) -> Self {
        LuaLib {
            ...
            lua_l_loadbufferx: *library.get(b"luaL_loadbufferx\0").unwrap(),
            lua_l_loadbuffer: *library.get(b"luaL_loadbuffer\0").unwrap(),
        }
    }
}
